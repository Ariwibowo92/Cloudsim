...
public class LeastConnectionLoadBalancers {

    //skenario 1 => testing cpu load
	...
	private static void printCloudletList(List<Cloudlet> list) {
		...
		Log.printLine("Cloudlet ID" + indent + "STATUS" + indent +
				"Data center ID" + indent + "VM ID" + indent + indent + "Response Time" + indent + "Start Time" + indent + "Finish Time");
	...
	public static void main(String[] args) {
		Log.printLine("Starting Least Connection Simulation...");
		...
		try {
			...
			cloudletList = createCloudlet(brokerId, 100, 0); // creating 100 cloudlets
			...
			Log.printLine(LeastConnectionLoadBalancers.class.getName() + " finished!");
		}
		catch (Exception e)
		{
			e.printStackTrace();
