...
/**
 * Least Connection {@link Vm} allocation policy.
 * 
 * @author alessandro
 */
public class LeastConnectionVmAllocationPolicy extends org.cloudbus.cloudsim.VmAllocationPolicy {
  
	private final Map<String, Host> vm_table = new HashMap<String, Host>();
	
	private final CircularHostList hosts;
	
	public LeastConnectionVmAllocationPolicy(List<? extends Host> list) {
		super(list);
